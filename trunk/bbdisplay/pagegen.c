...
static char rcsid[] = "$Id: pagegen.c,v 1.123 2004-12-18 08:49:53 henrik Exp $";
...
void do_summaries(dispsummary_t *sums, FILE *output)
{
	...
	for (s=sums; (s); s = s->next) {
		...
		if (newhost == NULL) {
			/* New summary "host" */
			newhost = init_host(s->row, NULL, NULL, NULL, NULL, 0,0,0,0, 0, 0.0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0);
