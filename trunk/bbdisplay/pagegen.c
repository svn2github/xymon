...
static char rcsid[] = "$Id: pagegen.c,v 1.128 2005-01-15 17:38:55 henrik Exp $";
...
void do_one_page(bbgen_page_t *page, dispsummary_t *sums, int embedded)
{
	...
	mkbblocal = xstrdup(getenv((page->parent ? "MKBBSUBLOCAL" : "MKBBLOCAL")));
