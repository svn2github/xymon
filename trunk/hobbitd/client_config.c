...
static char rcsid[] = "$Id: client_config.c,v 1.63 2008-01-14 21:20:28 henrik Exp $";
...
typedef enum { C_LOAD, C_UPTIME, C_CLOCK, C_DISK, C_MEM, C_PROC, C_LOG, C_FILE, C_DIR, C_PORT, C_SVC, C_PAGING } ruletype_t;
