...
static char openbsd_rcsid[] = "$Id: openbsd.c,v 1.3 2005-07-21 21:36:00 henrik Exp $";
...
void handle_openbsd_client(char *hostname, char *sender, time_t timestamp, char *clientdata)
{
	...
	unix_netstat_report(hostname, "openbsd", netstatstr);
	unix_vmstat_report(hostname, "openbsd", vmstatstr);
}
