...
GRAPH="wio.$dir"
GRAPHTITLE="$dir I/O wait rate"

#
################################################
################################################
# Graphes I/O wait for these periods :
#
...
--title "${GRAPHTITLE}" -w 600 -h 120 -u "wio" \
--units-exponent 0 --imgformat PNG \
'DEF:wio='${RRDARCHIVE}'sar.rrd:sar_wio:AVERAGE' \
'AREA:wio#FF9900: %I/O Wait \n' \
