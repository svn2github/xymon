...
This slides present a serious of hobbbit development topics. These topics include coding standard,compilation and test farm,software packaging,software distribution and auto update for hobbitmon supported OS platforms.
...
\mysubsection{GNU+TWW development model}
