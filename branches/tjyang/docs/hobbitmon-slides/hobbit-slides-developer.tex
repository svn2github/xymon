% Copyright (C) 2008  Hobbitmon Community.
...
% 
% USAGE
%       make -f Makefile to use latex to generat into different formats.
%
% DESCRIPTION
%
...
Copyright \copyright{} 2008  Hobbitmon Community\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{New Hobbitmon  Devevelopment Model}
...
\mysection{Why Hobbitmon developers Need autotools }
\begin{frame}
...
"Last-Translator: \alert<1>{Hobbitmon Community <hobbit@hswn.dk>}\\n"
